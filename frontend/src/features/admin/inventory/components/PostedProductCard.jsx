...
export default function ProductCard({ product, onEdit, onDelete }) {
    const { updateProductHighlight, updateProductStatus } =
    ...
    const handleToggleFeatured = async () => {
        ...
        setLoading(true);
        try {
            const updated = await updateProductHighlight(
                product._id,
                newHighlight
            );
    ...
    return (
        <>
            ...
            >
                ...
                <CardContent
                    sx={{ pb: "5px !important", p: 1, bgcolor: "white" }}
                >
                    <Stack>
                        <CustomPopover
                            trigger={
                        ...
                        <Typography
                            ...
                            sx={{ display: "flex" }}
                        >
                            <Stack sx={{ border: 1, my: 0.5, mr: 0.5 }} />
