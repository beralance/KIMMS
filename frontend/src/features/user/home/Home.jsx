                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Typography
                                            ...
                                            width={"100%"}
                                        >
                                            Explore our shop to find quality
                                            items at affordable prices — from
                                            everyday essentials to timeless
                                            pieces that add style and value to
                                            your home.
                                        </Typography>
                                    </Stack>
                                </Stack>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Typography
                                            ...
                                            width={"100%"}
                                        >
                                            Enter our auction and experience the
                                            thrill of bidding on unique
                                            treasures — compete, win, and bring
                                            home one-of-a-kind finds at the best
                                            value.
                                        </Typography>
                                    </Stack>
                                </Stack>
                        ...
                        <section style={{ height: "100%" }}>
                            <Stack alignItems={"center"} mb={3}>
                                ...
                                <Typography
                                    ...
                                    align="center"
                                >
                                    Learn which items are available for local
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid size={{ xs: 6 }}>
                                        <Stack height={300}>
                                            ...
                                            >
                                                Small items are lightweight and
                                                easy to ship, making them
                                                available for both local and
                                                international users. These
                                                include portable products such
                                                as bags, small appliances, home
                                                décor, and other compact
                                                merchandise. They are carefully
                                                packaged to ensure safe and
                                                affordable delivery, no matter
                                                where you are.
                                            </Typography>
                                        </Stack>
                                    </Grid>
                                ...
                                <Grid container spacing={2}>
                                    <Grid size={{ xs: 6 }}>
                                        <Stack height={300}>
                                            ...
                                            >
                                                Furniture and other bulky
                                                products that require special
                                                handling and local delivery
                                                services. Due to size and
                                                shipping constraints, these
                                                items are only available for
                                                local or users within{" "}
                                                <b>Region V</b> within our
                                                service area. Local customers
                                                can enjoy convenient delivery or
                                                in-store pickup for these larger
                                                pieces to ensure safety and
                                ...
                                <Stack gap={1}>
                                    <Stack alignItems={"center"} sx={{ mb: 2 }}>
                                        ...
                                        <Typography
                                            ...
                                            align="center"
                                        >
                                            Join the excitement — bid live, win
                                            big, and make it yours today!
                                        </Typography>
                                    </Stack>
                                    <Container>
                                        <AuctionLiveDisplayer
                        ...
                        <section>
                            <Stack alignItems={"center"}>
                                ...
                                <Typography
                                    ...
                                    sx={{ mb: 1 }}
                                >
                                    Spotlight on products we think you’ll love
                                    the most
                                </Typography>
