...
export default function ProductDetails() {
    ...
    return (
        <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, gap: { xs: 0, md: 4 }}}>
            ...
            >
                <Container sx={{ flex: { xs: 0, md: 1,}, bgcolor: 'white', borderRadius: '10px 10px 0px 0px', py: 2, pb: 10}}>
                    <section>
                        <Stack gap={2}>
                            <Stack sx={{gap: 4}}>
                                <Stack gap={1}>
                    ...
                    <section>
                        {recommendations.length > 0 && (
                            <Stack>
                                <Typography variant="body1" color="secondary" gutterBottom sx={{fontWeight: 'bold' }}>
                                    You may also like
                                </Typography>
                                <Box sx={{bgcolor: '#f0f0f0ff', p: 2, borderRadius: 2}}>
                                    <Box sx={{ display: 'flex', overflowX: 'auto', pb: 1, gap: 2, scrollBehavior: 'smooth', height: 'auto' }}>
