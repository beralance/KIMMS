            ...
            <SectionWrapper sx={{bgcolor: '#f0f0f0', gap: 2}}>
                <Stack>
                    <Typography variant="subtitle1" sx={{display: 'flex', alignItems: 'center', gap: 1}}>
                        <CircleIcon style={{color: '#37353E', fill: '#37353E'}}/>
                        Live Auctions
                    </Typography>
                ...
                :
                    <Stack alignItems={'center'} height={'40vh'} gap={1} justifyContent={'center'}>
                        <img 
                        ...
                        <Stack alignItems={'center'}>
                            <Typography variant="subtitle2" color="secondary" align="center">No Live Auctions Right Now</Typography>
                            <Typography variant="body2" color="gray" align="center">
                                There aren’t any ongoing auctions at the moment. Stay tuned for upcoming events!
                            </Typography>
                        </Stack>
                    </Stack>
                }
