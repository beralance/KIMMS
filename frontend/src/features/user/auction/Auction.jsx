...
import AuctionGuide from "./AuctionGuide";
        ...
        const fetchHistory = async () => {
            try {
                const res = await axios.get(
                    `${API_URL}/api/auctions/history/past`
                );
    ...
    useEffect(() => {
        const fetchAuctions = async () => {
            try {
                ...
                const pendingAuctions = res.data.filter(
                    (a) => a.status === "PENDING"
                );
                    ...
                    <Stack gap={5}>
                        ...
                        {pendingAuction.length > 0 && (
                            <AuctionSection
                                ...
                                subLabel={
                                    "Preview of items that will be up for auction soon"
                                }
