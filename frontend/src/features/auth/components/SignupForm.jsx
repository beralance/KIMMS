...
export default function SignUpForm() {
    ...
    const handleSignup = async (e) => {
        ...
        if (gender === "male")
            ...
            avatar =
                "https://ryanbajkoeratpmdwvuy.supabase.co/storage/v1/object/public/assets/account-avatar-profile-female-01.svg";
        else
            avatar =
                "https://ryanbajkoeratpmdwvuy.supabase.co/storage/v1/object/public/assets/account-avatar-profile-male-02.svg";
