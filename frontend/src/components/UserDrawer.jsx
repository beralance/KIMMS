...
import { Typography, Button, Stack, Divider, Badge } from "@mui/material";
...
export default function UserDrawer({
    ...
    React.useEffect(() => {
        const hasNotification = async () => {
            const notification = await hasUnreadNotifications(token);
    ...
    return (
        <Drawer anchor={anchor} open={open} onClose={onClose}>
            ...
            >
                {!user ? (
                    <Stack sx={{ alignItems: "center", my: 3, mx: 2 }}>
                        <img
                            src="/kimms-logo-full.svg"
                            alt="kimms-logo-full.svg"
                            style={{ width: 150 }}
                        />
                        <Typography
                            variant="body1"
                            ...
                            <Stack justifyContent={"center"}>
                                ...
                                >
                                    <Stack gap={1} sx={{ py: 1 }}>
                                        ...
                                        >
                                            <b>Local:</b> <br />
                                            Local user can buy and browser all
                                            products available both small and
                                            large items
                                        </Typography>
                                        <Typography
                                            variant="body2"
                                        ...
                                        >
                                            ...
                                            Products shown are only small items
                                        </Typography>
                                    </Stack>
                                </CustomPopover>
                            </Stack>
            ...
            <ProfilePicker
                ...
                userId={userId}
                token={token}
                onAvatarUpdate={(updated) => storeAvatarToLocal(updated)}
            />
        </Drawer>
    );
}
