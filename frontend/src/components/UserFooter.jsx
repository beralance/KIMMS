...
import { FileLockIcon, GavelIcon, HouseIcon, InfoIcon, ListTodoIcon, ShoppingBagIcon } from "lucide-react";

const quickLinks = [
    {icon: <HouseIcon/>, path: '/', label: 'Home'},
    {icon: <ShoppingBagIcon/>, path: '/shop', label: 'Shop'},
    {icon: <GavelIcon/>, path: '/auction', label: 'Auction'},
    {icon: <InfoIcon/>, path: '*', label: 'FAQ'},
]
        ...
        <Box sx={{ pb: 4, bgcolor: '#fafafa'}}>
            <Container maxWidth="lg">
                ...
                >
                    ...
                    <Stack alignItems={'center'}>
                        ...
                        <Stack gap={2}>
                            <Link href={'/'} underline="hover">
                                <Typography variant="body2" color="secondary" sx={{display: 'flex', textDecoration: 'underline', justifyContent: 'center', alignItems: 'center', gap: 1}}>
                                    <ListTodoIcon/>
                                    Terms & Conditions
                                </Typography>
                            </Link>
                    ...
                    <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                        ...
                        <Stack direction="row" spacing={1}>
                            <Link href="https://www.facebook.com/kimmsjapansurplus" target='_blank' underline="none" sx={{display: 'flex', color: 'secondary.primary', alignItems: 'center', gap: 1}}>
                                <FacebookIcon/>
                ...
                <Typography variant="body2" color="text.secondary" textAlign="center">
                    © 2025 Kimm’s Furniture & Merchandise
                </Typography>
            </Container>
        </Box>
    );
