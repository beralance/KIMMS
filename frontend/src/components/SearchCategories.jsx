...
import {ScrollSectionLeft, ScrollSectionRight} from './SectionTransitionX';

export default function CategoriesList({open, onClose}) {
            ...
            <Grid spacing={1} container>
                {categories.map((category) => (
                    <Grid size={{xs: 6}} key={category.categoryId} sx={{position: 'relative'}}>
                        <ScrollSectionLeft>
                            <Box onClick={() => handleCategoryClick(category.categoryId)}>
