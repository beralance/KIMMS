...
export default function AppRoutes() {
    return (
        <Routes>
            ...
            <Route
                path="/auction-checkout/:auctionId/:winner"
                element={
                    <UserProtectedRoute>
                        <Checkout />
                    </UserProtectedRoute>
            ...
            <Route element={<AuctionLayout />}>
                <Route
                    path="/auction/listing/details/:id"
                    element={<AuctionProductDetails />}
                />
                <Route
                    path="/auction/history/history-details/:id"
                    element={<AuctionHistoryDetails />}
                />
            </Route>
            <Route
                path="/auction/listing/product-preview/:id"
                element={<AuctionProductPreview />}
            />
            ...
            <Route element={<StaffProtectedRoute />}>
                ...
                >
                    <Route
                        index
                        element={
                            <StaffProtectedRoute moduleName="dashboard">
                                <StaffDashboard />
                            </StaffProtectedRoute>
                        }
                    />
                    <Route
                        path="inventory"
                        element={
                            <StaffProtectedRoute moduleName="inventory">
                                <Inventory />
                            </StaffProtectedRoute>
                        }
                    >
                        <Route
                            path="manage-inventory"
                            element={
                                <StaffProtectedRoute moduleName="inventory-management">
                                    <InventoryManagement />
                                </StaffProtectedRoute>
                            }
                        />
                        <Route
                            path="manage-product"
                            element={
                                <StaffProtectedRoute moduleName="product-management">
                                    <ProductManagement />
                                </StaffProtectedRoute>
                            }
                        />
                        <Route
                            path="manage-auction"
                            element={
                                <StaffProtectedRoute moduleName="auction-management">
                                    <AuctionManagement />
                                </StaffProtectedRoute>
                            }
                        />
                    ...
                    <Route
                        path="orders"
                        element={
                            <StaffProtectedRoute moduleName="order">
                                <Orders />
                            </StaffProtectedRoute>
                        }
                    />
                    <Route
                        path="reports"
                        element={
                            <StaffProtectedRoute moduleName="report">
                                <Reports />
                            </StaffProtectedRoute>
                        }
                    />
